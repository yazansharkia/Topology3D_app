...
const ScanInfoScreen = () => {
  ...
  const handleScan = () => {
    navigation.navigate('ScanCameraScreen' as never);
  };
    const handleBack = () => {
      navigation.goBack();
    };
  ...
  return (
    <ImageBackground style={styles.background}>
      <View style={styles.container}>
        ...
        {/* Title */}
        <Text style={styles.sectionTitle}>Scan your Foot</Text>
        <Text style={styles.sectionText}>
          Start scanning your foot to create a precise 3D model.
        </Text>
...
const styles = StyleSheet.create({
  container: {
    ...
    paddingBottom: height * 0.05, // Add bottom padding to prevent cutoff
  },
  background: {
    flex: 1,
    resizeMode: 'cover',
  ...
  privacyBox: {
    ...
    marginTop: height * 0.05, // Add top margin instead of top positioning
  },
  privacyIcon: {
