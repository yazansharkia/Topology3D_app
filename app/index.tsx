...
import { View, TextInput, Button, Text, TouchableOpacity, StyleSheet, Dimensions, Image, FlatList, Modal,Animated,Linking,Alert} from 'react-native';
import { useNavigation } from '@react-navigation/native';
import { createStackNavigator,TransitionPresets } from '@react-navigation/stack';
import AsyncStorage from 'react-native';
import { auth ,  db } from './firebase'; // <-- your firebase file
import { signInWithEmailAndPassword , signInAnonymously,deleteUser} from 'firebase/auth'; // <-- from Firebase
...
const LoginScreen = () => {
  ...
  const handleLogin = async () => {
      try {
            ...
            navigation.navigate('HomeScreen'); // or your next screen
          } catch (error) {
